...
public class MissingUpload extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_missing_upload);
        ...
        if (mImageUri != null) {
            ...
            Task<Uri> urlTask = mUploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                ...
                public void onSuccess(Object o) {
                    mprogressDialog = new ProgressDialog(MissingUpload.this);
