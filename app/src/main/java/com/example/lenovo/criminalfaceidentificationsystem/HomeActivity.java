...
public class HomeActivity extends AppCompatActivity {
    ...
    String arrayName[] = {"Missing People", "Upload", "Profile", " Logout"};
    int[] Icons = new int[]{R.drawable.ic_launcher_background,
    ...
    int[] Title = new int[]{R.string.missing, R.string.upload,
            R.string.profile, R.string.logout, R.string.back};
    int[] subTitle = new int[]{R.string.smw, R.string.supload,
        ...
        if (resultCode == Activity.RESULT_OK) {
            ...
            if (getPickImageResultUri(data) != null) {
                ...
                try {
                    ...
                    CircleImageView croppedImageView = (CircleImageView) findViewById(R.id.profile_image);
